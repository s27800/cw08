...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task2()
        {
            ...
            //method
            var methodSyntax =
                Emps.Where(e => e.Job.Equals("Frontend programmer") && e.Salary > 1000)
        ...
        {
            var syntax = 
                Emps.OrderByDescending(e => e.Salary).First().Salary;
        ...
        {
            var syntax = 
                Emps.Where(e => e.Salary == Emps.OrderByDescending(em => em.Salary).First().Salary);
